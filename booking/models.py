...
class Appointment(models.Model):
    ...
    service = models.CharField(max_length=50, choices=SERVICE_CHOICES, default="Business Strategy Development")
    day = models.DateField(default=datetime.now)
    day = models.CharField(max_length=10, choices=TIME_CHOICES, default="3 PM")
